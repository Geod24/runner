...
namespace GitHub.Runner.Common.Tests.Worker
{
    public sealed class ActionRunnerL0
    {
        ...
        public async void WarnInvalidInputs()
        {
            ...
            _ec.Verify(x => x.AddIssue(It.Is<Issue>(s => s.Message.Contains("Unrecognized input 'invalid1'")), It.IsAny<string>()), Times.Once);
            _ec.Verify(x => x.AddIssue(It.Is<Issue>(s => s.Message.Contains("Unrecognized input 'invalid2'")), It.IsAny<string>()), Times.Once);
        }
